...
--
-- Host: 127.0.0.1:8889
-- Generation Time: Apr 05, 2017 at 02:04 PM
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `image-path` text CHARACTER SET utf8 NOT NULL,
  `author` text CHARACTER SET utf8 NOT NULL,
  `author-link` text CHARACTER SET utf8,
  `link` text CHARACTER SET utf8,
  `link-name` varchar(255) CHARACTER SET utf8 DEFAULT NULL
